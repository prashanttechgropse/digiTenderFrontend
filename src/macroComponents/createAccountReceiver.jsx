...
class CreateAccountReceiver extends Form {
  state = {
    formData: {
      email: "",
      password: "",
              ...
              <div className="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div className="row wd-100p mx-auto text-center">
                  <div className="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                    <img
                      src="https://www.goinstablog.com/goinstablog.com/sumitdesign/design/digibids.com/receiver/common/img/backgrounds/receiver.png"
...
export default CreateAccountReceiver;
