...
class CustomerPaymentDetails extends Component {
  state = { paymentDetails: "" };

  componentDidMount = async () => {
    const { data } = await httpService.get(
      `${process.env.REACT_APP_APIENDPOINT}/admin/customerPaymentDetails/${this.props.match.params.paymentId}`
    );
  ...
  paymentPaid = async () => {
    ...
    try {
      const {
        ...
        `${process.env.REACT_APP_APIENDPOINT}/admin/paymentPaidByCustomer/${this.props.match.params.paymentId}`,
        { paidByCustomer: true }
      );
      if (data) {
        const paymentDetails = { ...this.state.paymentDetails };
  ...
  renderPaymentReceivedButton = () => {
    if (this.state.paymentDetails.paidByCustomer) return null;
    return (
      <div className="pr-1 mb-3 mb-xl-0">
        ...
        >
          <i className="fa fa-check"></i> payment received
        </button>
      ...
      <div className="container-fluid">
        <div className="breadcrumb-header justify-content-between">
          ...
          <div className="d-flex my-xl-auto right-content">
            {this.renderPaymentReceivedButton()}
                  ...
                  <div className="media-list pb-0">
                    ...
                    <div className="media">
                      <div className="media-body">
                        ...
                        <div>
                          <label> Tender Amount Status</label>
                          <span className="tx-medium">
                            {paymentDetails.paidByCustomer
                              ? "Paid"
                              : "Not paid"}
                          </span>
                        </div>
                    ...
                    <div className="media">
                      <div className="media-body">
                        <div>
                          <label> Tender commission Status</label>
                          <span className="tx-medium">
